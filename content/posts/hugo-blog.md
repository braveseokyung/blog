...
나는 결과적으로 이번 시리즈에서 설명할 Hugo 블로그로 정착했는데, 나에게 중요했던 부분들은 아래와 같다.
...
공부하다가 우연히 본 블로그의 테마가 마음에 들었는데, 검색해보니까 Hugo의 [DoIt](https://themes.gohugo.io/themes/doit/) 테마였다. 내가 생각하는 이 테마의 장점은 이렇다.
